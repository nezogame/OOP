...
CircleShape* Circle::get_figure() {
	return circle;
}
Color Circle::get_color() {
	return color;
}
Color Circle::get_new_color() {
	return new_color;
}
Color Circle::get_transparent_color() {
...
void Circle::change_color(Color color) {
	new_color = color;
	circle->setFillColor(new_color);
}
...
void Circle::auto_move(Vector2f mouse) {
