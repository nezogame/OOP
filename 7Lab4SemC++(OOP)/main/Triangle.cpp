...
CircleShape* Triangle::get_figure() {
	return triangle;
}
Color Triangle::get_color() {
	return color;
}
Color Triangle::get_new_color() {
	return new_color;
}
Color Triangle::get_transparent_color() {
...
void Triangle::change_color(Color color) {
	new_color = color;
	triangle->setFillColor(new_color);
}
...
void Triangle::auto_move(Vector2f mouse) {
