...
#include <iostream>
Star::Star() {
	star = new ConvexShape();
	star->setPointCount(10);
	color = Color(61, 77, 169);
	new_color = color;
	transparent_color = Color(0, 0, 0, 0);
	star->setFillColor(color);
	star->setPoint(0, Vector2f(60, 0));
	star->setPoint(1, Vector2f(72, 40));
	star->setPoint(2, Vector2f(110, 40));
	star->setPoint(3, Vector2f(80, 60));
	star->setPoint(4, Vector2f(100, 100));
	star->setPoint(5, Vector2f(60, 75));
	star->setPoint(6, Vector2f(20, 100));
	star->setPoint(7, Vector2f(40, 60));
	star->setPoint(8, Vector2f(10, 40));
	star->setPoint(9, Vector2f(48, 40));
}
Star::~Star() {
	delete star;
}
...
ConvexShape* Star::get_figure() {
	return star;
}
Color Star::get_color() {
	return color;
}
Color Star::get_new_color() {
	return new_color;
}
Color Star::get_transparent_color() {
...
void Star::change_color(Color color) {
	new_color = color;
	star->setFillColor(new_color);
}
...
void Star::auto_move(Vector2f mouse) {
